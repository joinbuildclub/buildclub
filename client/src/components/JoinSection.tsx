        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center py-8">              
            <a href="/auth/google" className="inline-block">
              <Button
                className="clay-button flex items-center justify-center gap-4 bg-white text-gray-700 hover:bg-gray-50 font-medium text-xl py-8 px-12 shadow-lg transition-all duration-200 border-2 border-gray-200 ring-2 ring-gray-100 outline outline-2 outline-gray-100 hover:scale-[0.98] hover:shadow-md"
              >
