        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center py-8">              
            <a href="/auth/google" className="inline-block">
              <Button
                className="clay-button flex items-center justify-center gap-4 bg-white text-gray-700 hover:bg-gray-50 font-medium text-xl py-8 px-12 shadow-lg transform transition-transform hover:scale-105"
              >
