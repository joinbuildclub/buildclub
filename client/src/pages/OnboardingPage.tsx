          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-8 mb-8">
                ...
                {/* Slack (full width) */}
                <a
                  href={communityLinks.slack.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full mb-4"
                >
                  <Card className="hover:bg-primary/5 transition-colors border-2 border-teal-200 bg-teal-50">
                    <CardContent className="p-6 flex items-center">
                      ...
                      <div>
                        <h3 className="font-bold text-lg">
                          {communityLinks.slack.name}
                        </h3>
                        <p className="text-gray-600">
                          {communityLinks.slack.description}
                        </p>
                      </div>
