...
import { extractDateComponents, formatDisplayDate, formatTimeRange } from "@/lib/dateUtils";
...
export default function EventDetailPage() {
  ...
  const processedDateTime = () => {
    if (!event) return { dateDisplay: "Date TBD", timeDisplay: "Time TBD", dateComponents: null };
  ...
  const { dateDisplay, timeDisplay, dateComponents } = event ? processedDateTime() : { dateDisplay: "Date TBD", timeDisplay: "Time TBD", dateComponents: null };
    ...
    <div className="page-container bg-gray-50 min-h-screen">
      ...
      <main className="main-content py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6">
            <Link href="/events">
              <Button variant="ghost" className="text-gray-600 hover:text-gray-900 p-0 hover:bg-transparent">
          ...
          {isLoading ? (
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center">
              ...
              <h3 className="text-xl font-medium text-red-800 mb-2">Event Not Found</h3>
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="flex items-center text-gray-700">
                      ...
                      <div>
                        <div className="font-medium">{dateComponents?.dayOfWeek}</div>
                        <div>{dateDisplay}</div>
                      </div>
                    </div>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md border border-gray-100">
                <div className="p-6 md:p-8">
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">More upcoming events coming soon!</p>
